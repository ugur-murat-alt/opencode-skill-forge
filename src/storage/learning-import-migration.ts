...
export const learningImportMigration: Migration = {
  up: async (db) => {
    await db.schema
      .createTable("learning_imports")
      ...
      .addPrimaryKeyConstraint("learning_import_pk", ["tenant_id", "id"])
      .addForeignKeyConstraint(
        "learning_import_member",
        ["tenant_id", "user_id"],
        "memberships",
        ["tenant_id", "user_id"],
      )
      .addForeignKeyConstraint(
        "learning_import_project",
