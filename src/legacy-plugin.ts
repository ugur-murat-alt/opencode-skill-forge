// Wrapper entrypoint.
//
// The skill-forge (skill evolution) subsystem ships as the precompiled
// `dist/skillforge-core.js` bundle (behaviour parity with the published
// 0.2.2 core). The prompt-editor subsystem is maintained as TypeScript source
// here and is registered alongside it — independent on/off via
// `options.promptEditor.enabled`, even when the master `enabled` flag is off.
import skillForge, { resolveOptions } from "../test/fixtures/legacy/skillforge-core.js";
